...
from .language_meta import KEYWORDS
...
class Lexer:
    # Only language keywords are reserved.  Pipeline process names remain
    # ordinary, case-sensitive names (so `Map` and `map` may coexist).
